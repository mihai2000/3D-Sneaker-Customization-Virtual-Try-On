...
const Shoe: React.FC = (props) => {
  ...
  return (
    <group
      ...
      dispose={null}
      onPointerOver={(e) => (
        e.stopPropagation(), setHovered(handlePointerMaterialName(e.object))
      )}
      ...
      onClick={(e) => {
        ...
        state.current = name in snap.items ? (name as keyof ItemsType) : null;
      }}
    >
      <mesh
        receiveShadow
