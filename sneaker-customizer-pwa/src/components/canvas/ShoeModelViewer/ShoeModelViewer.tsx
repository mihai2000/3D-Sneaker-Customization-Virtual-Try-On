...
const ShoeModelViewer: React.FC<Props> = ({
  ...
  const Maximize2 = React.lazy(() =>
    import('lucide-react').then((mod) => ({ default: mod.Maximize2 }))
  );
  const Minimize2 = React.lazy(() =>
    import('lucide-react').then((mod) => ({ default: mod.Minimize2 }))
  );
  const RotateCw = React.lazy(() =>
    import('lucide-react').then((mod) => ({ default: mod.RotateCw }))
  );
